...
if __name__ == "__main__":
  file_name = "tf_files/flower_photos/Shantanu/i_1.jpeg"
  ...
  for i in top_k:
    ...
    if (labels[i] =="shantanu" and results[i]>=0.9):
        ...
        break
    elif (labels[i] =="baby" and results[i]>=0.9):
        print("Match Found For Baby")
        readWrite.csvWrite("babyMovents.csv",0,0,1,0,0)
        break
    elif (labels[i] =="tiger" and results[i]>=0.9):
        print("Match Found For Person")
        readWrite.csvWrite("babyMovents.csv",0,0,0,1,0)
        break
    else:
        print("Baby Is Not Sleeping")
        readWrite.csvWrite("babyMovents.csv",0,0,0,0,1)
